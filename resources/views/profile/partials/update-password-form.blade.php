<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password" class="mt-1 block w-full bg-[#1a1a21] border-gray-700 text-white focus:border-blue-500 focus:ring-blue-500" autocomplete="current-password" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password" name="password" type="password" class="mt-1 block w-full bg-[#1a1a21] border-gray-700 text-white focus:border-blue-500 focus:ring-blue-500" autocomplete="new-password" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full bg-[#1a1a21] border-gray-700 text-white focus:border-blue-500 focus:ring-blue-500" autocomplete="new-password" />

<x-guest-layout>
    <div class="mb-6">
        ...
        <p class="text-gray-400 text-sm mt-1">Start tracking your bills today.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Repeat password" />
        ...
        <p class="mt-6 text-center text-sm text-gray-400">
            ...
            <a href="{{ route('login') }}" class="text-white font-bold hover:underline decoration-blue-500 underline-offset-4 transition">Sign in</a>
        </p>
    </form>
</x-guest-layout>
